class Task {
  ...
  initVariables() {
    ...
    this.iconWrap = document.getElementById("button-icon");
  }
  initEvents() {
  ...
  updateIcon() {
    this.iconWrap.innerHTML = this.icons[this.countIcon];
  }

  toggleIcon() {
    this.countIcon !== 0 ? (this.countIcon = 0) : (this.countIcon = 1);
    this.updateIcon();
  }
}

const start = new Task();
